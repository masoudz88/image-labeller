...
class LabelsToolkit extends React.Component {
    constructor(props) {
        super(props);
        ...
        const activeTab = props.activeLabelType ? props.activeLabelType : this.tabs[0];
    ...
    renderChildren = () => {
        ...
        return this.tabs.reduce((children, labelType, index) => {
            const isActive = labelType === activeLabelType;
            const tabData = find(LabelToolkitData, {labelType});
            const activeTabContentHeight = size.height - this.tabs.length * Settings.TOOLKIT_TAB_HEIGHT_PX;
