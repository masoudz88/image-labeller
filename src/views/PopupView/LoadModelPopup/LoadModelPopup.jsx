...
const LoadModelPopup = ({ updateActivePopupType }) => {
    ...
    const extractSelectedModel = () => {
        const model = findLast(selectedModelToLoad, { flag: true });
        if (!!model) {
            return model.model
        } else {
            return null;
    ...
    const onSelect = (selectedModel) => {
        const nextSelectedModelToLoad = selectedModelToLoad.map((model) => {
    ...
    const getOptions = () => {
        return selectedModelToLoad.map((entry) => {
            return (
                <div
