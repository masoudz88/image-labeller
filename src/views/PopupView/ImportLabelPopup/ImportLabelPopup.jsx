...
const ImportLabelPopup = (
    ...
    const resolveFormatType = labelType => {
    ...
    const resolveNotification = error => {
    ...
    const onAnnotationLoadSuccess = (imagesData, labelNames) => {
        setLoadedLabelNames(labelNames);
        setLoadedImageData(imagesData);
        setAnnotationsLoadedError(null);
    };

    const onAnnotationsLoadFailure = (error) => {
        setLoadedLabelNames([]);
        setLoadedImageData([]);
    ...
    const onAnnotationFormatChange = (format) => {
