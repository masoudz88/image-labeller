...
import { SocialMediaData } from "../../data/info/SocialMediaData";
import {ImageButton} from "../Common/ImageButton/ImageButton";

const MobileMainView = ({size}) => {
    const scrollPositionThreshold = 350;
    ...
    const getSocialMediaButtons = (mediaSize) => {
        return SocialMediaData.map((data, index) => {
            return (
                <ImageButton
                    key={index}
