...
describe('RectLabelsExporter wrapRectLabelIntoYOLO method', () => {
    it(
        'should produce correct single label entry given issue #171 example 1',
        () => {
            // given
            const labelRect = {
                id: 'label-rect-000',
            ...
            const [
                ...
                resultWidth,
                resultHeight
            ] = result.split(' ').map((value) => parseFloat(value))
    ...
    it(
        'should produce correct single label entry given issue #171 example 2',
        () => {
            // given
            const labelRect = {
                id: 'label-rect-000',
    ...
    it(
        'should produce correct single label entry given issue #171 example 3',
        () => {
            // given
            const labelRect = {
                id: 'label-rect-000',
