...
describe('YOLOUtils validateYOLOAnnotationComponents method', () => {
    it('should return false when incorrect number of components given', () => {
        // given
        const components = ['2', '0.342238', '0.054099', '0.069556'];
    ...
    it(
        'should return false when label name index higher than number of label names',
        () => {
            // given
            const components = ['2', '0.342238', '0.054099', '0.069556', '0.108199'];
    ...
    it(
        'should return false when one of coordinates values have value higher than one',
        () => {
            // given
            const components = ['2', '0.342238', '1.054099', '0.069556', '0.108199'];
    ...
    it(
        'should return false when one of coordinates values have value smaller than zero',
        () => {
            // given
            const components = ['2', '0.342238', '-0.054099', '0.069556', '0.108199'];
    ...
    it('should return true', () => {
        // given
        const components = ['6', '0.557911', '0.924187', '0.000673', '0.000000'];
...
describe('YOLOUtils parseYOLOAnnotationFromString method', () => {
    it('should return correct LabelRect', () => {
        // given
        const rawAnnotation = '1 0.300000 0.200000 0.300000 0.200000';
        ...
        const imageName = '0000.png';

        // when
        const result = YOLOUtils.parseYOLOAnnotationFromString(rawAnnotation, labelNames, imageSize, imageName);

        // then
        const rect = { x: 150, y: 100, width: 300, height: 200 };
    ...
    it('should throw AnnotationsParsingError', () => {
        // given
        const rawAnnotation = '4 0.340000 0.540000 0.060000 0.100000';
        const labelId = uuidv4();
        const labelNames = [
            {
                id: uuidv4(),
...
describe('YOLOUtils parseYOLOAnnotationsFromString method', () => {
    it('should return correct array of LabelRect', () => {
        ...
        // when
        const result = YOLOUtils.parseYOLOAnnotationsFromString(rawAnnotations, labelNames, imageSize, imageName);
